...
<div class="flex">
	...
	<div class="w-full p-5">
		...
		<Input placeholder="5..." class="mb-4" bind:value={data.auth.max_auth_attempts} />
		...
		>
		<Input placeholder="500000..." class="mb-4" bind:value={data.auth.lockout_timeout} />
		<Tooltip
		...
		<div class="flex mb-4 p-2 rounded border border-gray-200">
			...
			<Toggle class="w-1/2 justify-end" bind:checked={data.auth.allow_change_pw} />
		</div>
		...
		<div class="flex mb-4 p-2 rounded border border-gray-200">
			...
			<Toggle class="w-1/2 justify-end" bind:checked={data.auth.enforce_strong_pw} />
		</div>
		<Tooltip
