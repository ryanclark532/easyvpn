...
import { createGroupsStore } from '$lib/stores/groups';
...
const _groupsStore = await createGroupsStore();
export { _authStore, _userStore, _vpnStore, _connectionsStore, _groupsStore };
