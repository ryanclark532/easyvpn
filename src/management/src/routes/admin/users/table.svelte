			...
			>
				...
				>
					...
					<button
						...
						on:click={() => (showActionOptions = !showActionOptions)}
					...
					{#if showActionOptions}
						<div
							class="origin-top-right absolute right-0 top-14 mt-2 w-54 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5"
						>
							<ul class="py-1">
								<li>
									<a
										on:click={() => (deleteModal = !deleteModal)}
										href="#"
								...
								<li>
									<a
										on:click={() => (tempPasswordModal = !tempPasswordModal)}
										href="#"
										class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
										>Set Tempory Password</a
									>
								</li>
								<li>
									<a
										on:click={() => (toggleAdmin = !toggleAdmin)}
										href="#"
										class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
										>Toggle Admin On Selected</a
									>
								</li>
								<li>
									<a
										on:click={() => (toggleEnabled = !toggleEnabled)}
										href="#"
										class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
										>Toggle Enabled On Selected</a
									>
								</li>
							</ul>
						</div>
